...
const SOCIAL_LINKS = [
  {
    name: "Instagram",
    url: "https://instagram.com/dataatuci",
    icon: (
      <svg
        className="w-6 h-6"
        fill="currentColor"
...
export default function Contact() {
  ...
  return (
    <section id="contact" className="min-h-[500px] bg-white py-32 px-6">
        ...
        <div className="grid md:grid-cols-[200px,1fr] gap-12">
          ...
          <div>
            <motion.div
              ...
              className="max-w-2xl"
            >
              <h2 className="text-4xl md:text-5xl font-outfit font-light mb-8 text-gray-900">
                Get in Touch
              </h2>
              <p className="text-xl text-gray-600 font-chillax mb-12">
